function [w1_final b1_final w2_final b2_final] = OneHiddenLayer_Training(features_train, labels_train, features_test, labels_test)
...
w_layer1 = -sqrt(6/(3072 + hidden_neurons)) + 2*sqrt(6/(3072 + hidden_neurons))*rand(hidden_neurons,3072);
b_layer1 = -sqrt(6/(3072 + hidden_neurons)) + 2*sqrt(6/(3072 + hidden_neurons))*rand(hidden_neurons,1);
w_layer2 = -sqrt(6/(3072 + hidden_neurons)) + 2*sqrt(6/(3072 + hidden_neurons))*rand(10,hidden_neurons);
b_layer2 = -sqrt(6/(3072 + hidden_neurons)) + 2*sqrt(6/(3072 + hidden_neurons))*rand(10,1);
